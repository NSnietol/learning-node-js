...
class TicketControl{
    ...
    constructor(){
        ...
        this.numero_escritorio_busqueda;
    ...
    asignarTicket(escritorio){
        ...
        console.log('En atencion',this.tickets_en_atencion);

        function  findByEscritorio(element) {
            console.log('Escritorio',escritorio);
            return element.escritorio===escritorio;
        }
        // A lo mal, buscaré otra solucion
          this.numero_escritorio_busqueda=escritorio;

        var index_escritorio = this.tickets_en_atencion.findIndex(findByEscritorio);

     this.tickets_en_atencion.splice(index_escritorio,index_escritorio,nuevo_ticket);

        console.log('En atencion despues',this.tickets_en_atencion);
